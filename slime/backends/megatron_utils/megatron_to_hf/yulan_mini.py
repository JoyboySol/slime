...
def _convert_mtp_layer(args, name, param, layer_idx):
    ...
    if "transformer_layer" in name:
        ...
        mapped_params = convert_yulan_mini_to_hf(args, proxy_name, param)
...
def convert_yulan_mini_to_hf(args, name, param):
    ...
    if match:
        ...
        if rest == "self_attention.linear_proj.weight":
            ...
            # Hybrid GDN checkpoints still use the standard GQA-packed full-attention QKV layout.

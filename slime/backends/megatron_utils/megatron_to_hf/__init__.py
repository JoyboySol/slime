...
from .yulan_mini import convert_yulan_mini_to_hf
...
def _convert_to_hf_core(args, model_name, name, param):
    ...
    elif "yulan_mini" in model_name or "yulan-mini" in model_name:
        converted_named_tensors = convert_yulan_mini_to_hf(args, name, param)
